...
from myPipelineOrigin import CatVTONPipeline
...
class VITONHDTrainDataset(Dataset):
    ...
    def load_data(self):
        ...
        data_root = os.path.join(self.args.data_dir, "test")
...
def parse_args():
    ...
    parser.add_argument("--random_flip", type=bool, default=False)
    parser.add_argument("--unet_ckpt", type=str, default='/mnt/sda2/lry/catViton_dreamedit_accumalateNew_noema_batch48_0509/checkpoint-30000/model.safetensors')
    #parser.add_argument("--eval_pair", type=int, default=None)
    parser.add_argument(
        "--base_model_path",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="output_dreamedit_accmulateNew_noema_batch48_0509_test",
    ...
    parser.add_argument(
        "--batch_size", type=int, default=20, help="The batch size for evaluation."
    )
...
def main():
    ...
    pipeline = CatVTONPipeline(
        attn_ckpt_version=args.dataset_name,  # 没有用到
        attn_ckpt=args.resume_path,  # 没有用到
    ...
    for batch in tqdm(dataloader):
        ...
        for i, result in enumerate(results):
            ...
            if args.concat_eval_results:
                ...
                #concated_result.paste(result_orig, (w * 3, 0))
